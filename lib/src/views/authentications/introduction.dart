                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: (){}, child: const Text("SIGN IN", style: TextStyle(color: GlobalVariables.textColorWhite),)
                                )
                              ),
                            ),
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: (){}, child: const Text("CREATE ACCOUNT", style: TextStyle(color: GlobalVariables.buttonColorGreen),
                                  )
                                )
                              ),
                            ),
                            Padding(
                              ...
                              child: TextButton.icon(
                                  ...
                                  onPressed: (){}, label: const Text("CREATE ACCOUNT", style: TextStyle(color: GlobalVariables.buttonColorWhite),
                                  )
                                )
                              ),
                            Padding(
